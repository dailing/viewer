...
def ensure_view_home() -> None:
    for path in (VIEW_HOME, LOG_DIR, CODEX_LOG_DIR, CODEX_APP_SERVER_LOG_DIR, HERMES_LOG_DIR, OPENCODE_LOG_DIR, TERMINAL_LOG_DIR, CODEX_RUN_DIR, HERMES_RUN_DIR, WEAVER_RUN_DIR):
