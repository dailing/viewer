...
func TestRegistryOrderAndCompleteness(t *testing.T) {
	...
	want := []string{"bus-inspector", "config-store", "llm", "viewer.agent-hermes", "viewer.agent-codex", "viewer.agent-opencode", "instance-store", "file-service", "chat", "viewer.loop", "voice-control", "voice", "terminal", "supervisor", "gateway"}
