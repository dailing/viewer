...
func TestRegistryOrderAndCompleteness(t *testing.T) {
	...
	want := []string{"bus-inspector", "config-store", "viewer.agent-hermes", "viewer.agent-codex", "viewer.agent-opencode", "instance-store", "file-service", "chat", "terminal", "supervisor", "gateway"}
