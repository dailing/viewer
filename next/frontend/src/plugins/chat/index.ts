...
function createDockProvider(ctx: PluginCtx): DockProvider {
  ...
  return { type: "chat", icon: "bi-chat-left-text", title: "聊天", instances };
}
...
export default definePlugin({
  ...
  components: {
    ...
    chats: defineAsyncComponent(() => import("./ChatsPanel.vue")),
    roles: defineAsyncComponent(() => import("./RolesPanel.vue")),
    routes: defineAsyncComponent(() => import("./RoutesPanel.vue")),
  },
  createDockProvider,
});
